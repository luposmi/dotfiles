...
local function set_keymaps(harpoon)
    ...
    vim.keymap.set("n", "<C-d>", function() harpoon:list():select(2) end, { desc = "Catch third item in harpoon"})
    vim.keymap.set("n", "<C-f>", function() harpoon:list():select(3) end, { desc = "Catch fourth item in harpoon"})
