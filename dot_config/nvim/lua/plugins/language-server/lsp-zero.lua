return {
    ...
    config = function()
        ...
        lsp_zero.on_attach(function(_, bufnr)
            ...
            vim.keymap.set("n", "<leader>vw", function() vim.lsp.buf.workspace_symbol() end, { unpack(opts), desc = "search for workspace symbol"})
            vim.keymap.set("n", "<leader>vc", function() vim.lsp.buf.code_action()      end, { unpack(opts), desc = "lsp code action"})
            vim.keymap.set("n", "<leader>vr", function() vim.lsp.buf.references()       end, { unpack(opts), desc = "lsp show references"})
            vim.keymap.set("n", "<leader>vn", function() vim.lsp.buf.rename()           end, { unpack(opts), desc = "lsp rename"})
